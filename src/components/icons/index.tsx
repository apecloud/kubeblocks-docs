...
export const SlackIconColor = (props: SvgIconProps) => (
  <SvgIcon {...props} viewBox="0 0 24 24">
    <path
      fill="#E01E5A"
      d="M4.627 13.864a2.301 2.301 0 0 1 -2.305 2.304A2.301 2.301 0 0 1 0.018 13.864a2.301 2.301 0 0 1 2.304 -2.304h2.305zm1.152 0a2.301 2.301 0 0 1 2.304 -2.304 2.301 2.301 0 0 1 2.304 2.304v5.762a2.301 2.301 0 0 1 -2.304 2.304 2.301 2.301 0 0 1 -2.304 -2.304z"
    />
    <path
      fill="#36C5F0"
      d="M8.084 4.61a2.301 2.301 0 0 1 -2.304 -2.305A2.301 2.301 0 0 1 8.084 0a2.301 2.301 0 0 1 2.304 2.304V4.611zm0 1.17a2.301 2.301 0 0 1 2.304 2.304 2.301 2.301 0 0 1 -2.304 2.304H2.304A2.301 2.301 0 0 1 0 8.085a2.301 2.301 0 0 1 2.304 -2.304z"
    />
    <path
      fill="#2EB67D"
      d="M17.32 8.084a2.301 2.301 0 0 1 2.305 -2.304 2.301 2.301 0 0 1 2.304 2.304 2.301 2.301 0 0 1 -2.304 2.304h-2.305zm-1.152 0a2.301 2.301 0 0 1 -2.304 2.304 2.301 2.301 0 0 1 -2.305 -2.304V2.304A2.301 2.301 0 0 1 13.864 0a2.301 2.301 0 0 1 2.304 2.304z"
    />
    <path
      fill="#ECB22E"
      d="M13.864 17.32a2.301 2.301 0 0 1 2.304 2.304 2.301 2.301 0 0 1 -2.304 2.305 2.301 2.301 0 0 1 -2.304 -2.305v-2.304zm0 -1.152a2.301 2.301 0 0 1 -2.304 -2.304 2.301 2.301 0 0 1 2.304 -2.304h5.78a2.301 2.301 0 0 1 2.304 2.304 2.301 2.301 0 0 1 -2.304 2.304z"
    />
  </SvgIcon>
);
