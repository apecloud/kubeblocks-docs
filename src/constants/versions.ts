export const versionOptions = [
  { id: "stable", label: "v1.0.0", value: "v1.0.0", description: "Latest stable release", recommended: true },
  { id: "beta", label: "v1.0.0-beta.48", value: "v1.0.0-beta.48", description: "Latest beta release" },
  { id: "previous", label: "v0.9.3", value: "v0.9.3", description: "Previous stable release" },
];

// 文档路径到版本的映射
export const docPathToVersion: Record<string, string> = {
  "release-1_0": "v1.0.0",
  "preview": "v1.0.0-beta.48",
