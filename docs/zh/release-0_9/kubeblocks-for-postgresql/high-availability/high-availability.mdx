...
1. 查看 PostgreSQL 集群的初始状态。
   ...
   ![PostgreSQL 集群原始状态](/img/docs/zh/api-ha-pg-original-status.png)
...
4. 连接到 PostgreSQL 集群，查看集群信息。
   ...
   ![PostgreSQL 集群信息](/img/docs/zh/api-ha-pg-replication-info.png)
...
5. 查看集群，检查实例角色。
   ...
   ![PostgreSQL 高可用切换后集群状态](/img/docs/zh/api-ha-pg-after.png)
...
1. 查看 PostgreSQL 集群的初始状态。
   ...
   ![PostgreSQL 集群原始状态](/img/docs/zh/pgsql-ha-before.png)
...
4. 连接到 PostgreSQL 集群，查看集群信息。
   ...
   ![PostgreSQL 集群信息](/img/docs/zh/pgsql-ha-pg_stat_replication.png)
...
5. 查看集群，检查实例角色。
   ...
   ![PostgreSQL 高可用切换后集群状态](/img/docs/zh/pgsql-ha-after.png)
