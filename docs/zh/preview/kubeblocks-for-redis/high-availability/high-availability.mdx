...
1. 查看 Redis 集群的初始状态。
   ...
   ![Redis cluster original status](/img/docs/zh/redis-high-availability-initial-status.png)
...
4. 连接到 Redis 集群，查看异常发生后的主节点信息。
   ...
   ![Redis info replication](/img/docs/zh/redis-high-availability-status-after-exception.png)
...
5. 查看集群，检查实例角色。
   ...
   ![Redis cluster status after HA](/img/docs/zh/redis-high-availability-role.png)
