...
<li>
`$(SVC_PORT_&#123;PORT-NAME&#125;)` is ServicePort&rsquo;s port value with specified port name, i.e, a servicePort JSON struct:
...
<h3 id="apps.kubeblocks.io/v1alpha1.ClusterVersion">
ClusterVersion
...
<p>
Contains a list of versioning contexts for the components&rsquo; containers.
</p>
...
`parallelPodManagementConcurrency`<br/>
<em>
...
<h3 id="apps.kubeblocks.io/v1alpha1.ComponentClassDefinition">
...
<p>
When `hostNetwork` option is enabled, the Pods share the host&rsquo;s network namespace and can directly access
...
<ul>
<li>
Service selection: The Component&rsquo;s exposed Services may target replicas based on their roles using `roleSelector`.
</li>
<li>
...
with `preCondition` specifying when the action should be fired relative to the Component&rsquo;s lifecycle stages:
...
<h3 id="apps.kubeblocks.io/v1alpha1.ComponentResourceConstraint">
...
`reloadStaticParamsBeforeRestart`<br/>
<em>
bool
</em>
...
<h3 id="apps.kubeblocks.io/v1alpha1.OpsDefinition">
OpsDefinition
...
<h3 id="apps.kubeblocks.io/v1alpha1.OpsRequest">
OpsRequest
...
<em>(Optional)</em>
<p>
Indicates whether the current operation should be canceled and terminated gracefully if it&rsquo;s in the
&ldquo;Pending&rdquo;, &ldquo;Creating&rdquo;, or &ldquo;Running&rdquo; state.
</p>
<p>
This field applies only to &ldquo;VerticalScaling&rdquo; and &ldquo;HorizontalScaling&rdquo; opsRequests.
</p>
<p>
...
<p>
This is useful for concurrent execution of &lsquo;VerticalScaling&rsquo; and &lsquo;HorizontalScaling&rsquo; opsRequests.
...
<em>(Optional)</em>
<p>
Indicates whether opsRequest should continue to queue when &lsquo;force&rsquo; is set to true.
</p>
...
<p>
Specifies the type of this operation. Supported types include &ldquo;Start&rdquo;, &ldquo;Stop&rdquo;, &ldquo;Restart&rdquo;, &ldquo;Switchover&rdquo;,
...
&ldquo;Expose&rdquo;, &ldquo;DataScript&rdquo;, &ldquo;RebuildInstance&rdquo;, &ldquo;Custom&rdquo;.
</p>
<p>
...
(when `opsRequest.status.phase` is &ldquo;Succeed&rdquo;) before automatic deletion.
</p>
...
`ttlSecondsAfterUnsuccessfulCompletion`<br/>
<em>
int32
</em>
...
for any phase other than &ldquo;Succeed&rdquo; (e.g., &ldquo;Failed&rdquo;, &ldquo;Cancelled&rdquo;, &ldquo;Aborted&rdquo;) before automatic deletion.
</p>
...
`preConditionDeadlineSeconds`<br/>
<em>
int32
</em>
...
<h3 id="apps.kubeblocks.io/v1alpha1.ActionTask">
ActionTask
...
<p>
Indicates the current status of the task, including &ldquo;Processing&rdquo;, &ldquo;Failed&rdquo;, &ldquo;Succeed&rdquo;.
</p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.ActionTaskStatus">
ActionTaskStatus
(`string` alias)
</h3>
<p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.Backup">
Backup
...
<p>
If the `deletionPolicy` is set to &lsquo;Delete&rsquo;, then the associated backup data will also be deleted
...
<h3 id="apps.kubeblocks.io/v1alpha1.BackupMethod">
BackupMethod
...
<h3 id="apps.kubeblocks.io/v1alpha1.BackupPolicy">
BackupPolicy
...
<h3 id="apps.kubeblocks.io/v1alpha1.BackupPolicyTemplate">
...
<h3 id="apps.kubeblocks.io/v1alpha1.BackupPolicyTemplateSpec">
BackupPolicyTemplateSpec
...
<h3 id="apps.kubeblocks.io/v1alpha1.BackupPolicyTemplateStatus">
BackupPolicyTemplateStatus
...
<h3 id="apps.kubeblocks.io/v1alpha1.BackupRefSpec">
BackupRefSpec
...
<h3 id="apps.kubeblocks.io/v1alpha1.CPUConstraint">
CPUConstraint
...
<em>(Optional)</em>
<p>
The valid vcpu cores, it&rsquo;s useful if you want to define valid vcpu cores explicitly.
If Slots is specified, Max, Min, and Step are ignored
</p>
...
<em>(Optional)</em>
<p>
Defines spec for `Consensus` workloads. It&rsquo;s required if the workload type is `Consensus`.
</p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.ClusterComponentVersion">
ClusterComponentVersion
...
`roleProbeTimeoutAfterPodsReady`<br/>
<em>
int32
</em>
...
`multipleClusterObjectOption`<br/>
<em>
...
<h3 id="apps.kubeblocks.io/v1alpha1.ClusterResourceConstraintSelector">
ClusterResourceConstraintSelector
...
<p>
When a Component needs to access another Cluster&rsquo;s ClusterService using the `serviceRef` field,
...
<h3 id="apps.kubeblocks.io/v1alpha1.ClusterVersionSpec">
ClusterVersionSpec
...
<h3 id="apps.kubeblocks.io/v1alpha1.ClusterVersionStatus">
ClusterVersionStatus
...
<h3 id="apps.kubeblocks.io/v1alpha1.CompletionProbe">
CompletionProbe
...
<h3 id="apps.kubeblocks.io/v1alpha1.ComponentClass">
ComponentClass
...
<em>(Optional)</em>
<p>
args are variable&rsquo;s value
</p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.ComponentClassDefinitionSpec">
ComponentClassDefinitionSpec
...
<h3 id="apps.kubeblocks.io/v1alpha1.ComponentClassDefinitionStatus">
ComponentClassDefinitionStatus
...
<h3 id="apps.kubeblocks.io/v1alpha1.ComponentClassGroup">
ComponentClassGroup
...
<h3 id="apps.kubeblocks.io/v1alpha1.ComponentClassSeries">
ComponentClassSeries
...
For example:
name: &ldquo;general-&#123;&#123; .cpu &#125;&#125;c&#123;&#123; .memory &#125;&#125;g&rdquo;
</p>
...
<em>(Optional)</em>
<p>
Represents the current status of the ComponentDefinition. Valid values include ``,`Available`, and`Unavailable<code>.
...
<h3 id="apps.kubeblocks.io/v1alpha1.ComponentInfo">
ComponentInfo
...
The `portName` is transformed by replacing &lsquo;-&rsquo; with &lsquo;_&rsquo; and converting to uppercase.
</p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.ComponentOps">
ComponentOps
...
<h3 id="apps.kubeblocks.io/v1alpha1.ComponentResourceConstraintSelector">
ComponentResourceConstraintSelector
...
<h3 id="apps.kubeblocks.io/v1alpha1.ComponentResourceConstraintSpec">
ComponentResourceConstraintSpec
...
<h3 id="apps.kubeblocks.io/v1alpha1.ComponentResourceKey">
...
and the value will be presented in the following format: instanceName1,instanceName2,&hellip;
</p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.ConfigurationItem">
ConfigurationItem
...
<h3 id="apps.kubeblocks.io/v1alpha1.ConfigurationItemStatus">
...
Possible values include &ldquo;Creating&rdquo;, &ldquo;Init&rdquo;, &ldquo;Running&rdquo;, &ldquo;Pending&rdquo;, &ldquo;Merged&rdquo;, &ldquo;MergeFailed&rdquo;, &ldquo;FailedAndPause&rdquo;,
&ldquo;Upgrading&rdquo;, &ldquo;Deleting&rdquo;, &ldquo;FailedAndRetry&rdquo;, &ldquo;Finished&rdquo;, &ldquo;ReconfigurePersisting&rdquo;, &ldquo;ReconfigurePersisted&rdquo;.
</p>
...
Possible values include &ldquo;None&rdquo;, &ldquo;Retry&rdquo;, &ldquo;Failed&rdquo;, &ldquo;NotSupport&rdquo;, &ldquo;FailedAndRetry&rdquo;.
</p>
<ul>
<li>
&ldquo;None&rdquo; describes fsm has finished and quit.
</li>
<li>
&ldquo;Retry&rdquo; describes fsm is running.
</li>
<li>
&ldquo;Failed&rdquo; describes fsm is failed and exited.
</li>
<li>
&ldquo;NotSupport&rdquo; describes fsm does not support the feature.
</li>
<li>
&ldquo;FailedAndRetry&rdquo; describes fsm is failed in current state, but can be retried.
</li>
</ul>
...
<h3 id="apps.kubeblocks.io/v1alpha1.ConnectionCredentialKey">
...
If not specified, the default key &ldquo;password&rdquo; is used.
</p>
...
If not specified, the default key &ldquo;username&rdquo; is used.
</p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.CustomOps">
CustomOps
...
<p>
It accepts an absolute number (e.g., 5) or a percentage of components to execute in parallel (e.g., &ldquo;10%&rdquo;).
Percentages are rounded up to the nearest whole number of components.
For example, if &ldquo;10%&rdquo; results in less than one, it rounds up to 1.
</p>
<p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.CustomOpsComponent">
CustomOpsComponent
...
<h3 id="apps.kubeblocks.io/v1alpha1.EnvMappingVar">
EnvMappingVar
...
<h3 id="apps.kubeblocks.io/v1alpha1.EnvVarRef">
EnvVarRef
...
This name can originate from an &lsquo;env&rsquo; entry or be a data key from an &lsquo;envFrom&rsquo; source.
</p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.Expose">
Expose
...
&lsquo;Enable&rsquo; exposes the services. while &lsquo;Disable&rsquo; removes the exposed Service.
</p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.ExposeSwitch">
ExposeSwitch
(`string` alias)
</h3>
<p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.HorizontalScaling">
HorizontalScaling
...
Specifies the number of replicas for the component. Cannot be used with &ldquo;scaleIn&rdquo; and &ldquo;scaleOut&rdquo;.
</p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.Instance">
Instance
...
<h3 id="apps.kubeblocks.io/v1alpha1.InstanceReplicasTemplate">
...
<h3 id="apps.kubeblocks.io/v1alpha1.InstanceResourceTemplate">
...
<h3 id="apps.kubeblocks.io/v1alpha1.InstanceVolumeClaimTemplate">
...
<h3 id="apps.kubeblocks.io/v1alpha1.JSONPatchOperation">
JSONPatchOperation
...
<p>
Specifies the type of JSON patch operation. It supports the following values: &lsquo;add&rsquo;, &lsquo;remove&rsquo;, &lsquo;replace&rsquo;.
</p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.KBAccountType">
KBAccountType
(`byte` alias)
</h3>
<div>
...
<h3 id="apps.kubeblocks.io/v1alpha1.LastComponentConfiguration">
...
<em>(Optional)</em>
<p>
Records volumes&rsquo; storage size of the Component prior to any changes.
</p>
...
The &ldquo;pods&rdquo; key maps to a list of names of all Pods of the Component.
</p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.LastConfiguration">
LastConfiguration
...
These are known as &ldquo;builtin&rdquo; handlers, includes: `mysql`, `redis`, `mongodb`, `etcd`,
...
<h3 id="apps.kubeblocks.io/v1alpha1.MatchExpressions">
MatchExpressions
...
for example, you can use &lsquo;&#123;&#123; eq .spec.replicas 1 &#125;&#125;&rsquo;.
</p>
...
Should evaluate to either `true` or `false`.
The current resource object is parsed into the Go template.
for example, using &lsquo;&#123;&#123; eq .spec.replicas 1 &#125;&#125;&rsquo;
</p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.MemoryConstraint">
MemoryConstraint
...
Reference: <a href="https://cloud.google.com/compute/docs/general-purpose-machines#custom_machine_types">https://cloud.google.com/compute/docs/general-purpose-machines#custom_machine_types</a>
</p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.OpsAction">
OpsAction
...
<div>
<p>
OpsAction specifies a custom action defined in OpsDefinition for execution in a &ldquo;Custom&rdquo; OpsRequest.
</p>
<p>
...
<ul>
<li>
&ldquo;Fail&rdquo;: Marks the entire OpsRequest as failed if the action fails.
</li>
<li>
&ldquo;Ignore&rdquo;: The OpsRequest continues processing despite the failure of the action.
</li>
</ul>
...
<ul>
<li>
For &lsquo;workload&rsquo; or &lsquo;exec&rsquo; actions, parameters are injected as environment variables.
</li>
<li>
For &lsquo;resourceModifier&rsquo; actions, parameter can be referenced using $() in fields
...
<em>(Optional)</em>
<p>
Specifies the configuration for a &lsquo;workload&rsquo; action.
...
<em>(Optional)</em>
<p>
Specifies the configuration for a &lsquo;exec&rsquo; action.
It creates a Pod and invokes a &lsquo;kubectl exec&rsquo; to run command inside a specified container with the target Pod.
</p>
...
<em>(Optional)</em>
<p>
Specifies the configuration for a &lsquo;resourceModifier&rsquo; action.
...
<h3 id="apps.kubeblocks.io/v1alpha1.OpsDefinitionSpec">
OpsDefinitionSpec
...
<h3 id="apps.kubeblocks.io/v1alpha1.OpsDefinitionStatus">
OpsDefinitionStatus
...
When it equals to &ldquo;Available&rdquo;, the OpsDefinition is ready and can be used in a &ldquo;Custom&rdquo; OpsRequest.
</p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.OpsEnvVar">
OpsEnvVar
...
<p>
Specifies the source of the environment variable&rsquo;s value.
</p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.OpsExecAction">
OpsExecAction
...
<p>
The command to be executed via &lsquo;kubectl exec &ndash;&rsquo;.
</p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.OpsPhase">
OpsPhase
(`string` alias)
</h3>
<p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.OpsRecorder">
OpsRecorder
...
<h3 id="apps.kubeblocks.io/v1alpha1.OpsRequestBehaviour">
OpsRequestBehaviour
...
<h3 id="apps.kubeblocks.io/v1alpha1.OpsRequestComponentStatus">
...
Possible values include &ldquo;Creating&rdquo;, &ldquo;Running&rdquo;, &ldquo;Updating&rdquo;, &ldquo;Stopping&rdquo;, &ldquo;Stopped&rdquo;, &ldquo;Deleting&rdquo;, &ldquo;Failed&rdquo;, &ldquo;Abnormal&rdquo;.
</p>
...
<em>(Optional)</em>
<p>
Records the timestamp when the Component last transitioned to a &ldquo;Failed&rdquo; or &ldquo;Abnormal&rdquo; phase.
</p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.OpsRequestSpec">
OpsRequestSpec
...
<h3 id="apps.kubeblocks.io/v1alpha1.OpsRequestStatus">
OpsRequestStatus
...
Possible values include &ldquo;Pending&rdquo;, &ldquo;Creating&rdquo;, &ldquo;Running&rdquo;, &ldquo;Cancelling&rdquo;, &ldquo;Cancelled&rdquo;, &ldquo;Failed&rdquo;, &ldquo;Succeed&rdquo;.
</p>
...
`reconfiguringStatusAsComponent`<br/>
<em>
<a href="#apps.kubeblocks.io/v1alpha1.ReconfiguringStatus">
...
<em>(Optional)</em>
<p>
Records the status of a reconfiguring operation if `opsRequest.spec.type` equals to &ldquo;Reconfiguring&rdquo;.
</p>
...
&ldquo;VersionUpgrading&rdquo;, &ldquo;Exposing&rdquo;, &ldquo;ExecuteDataScript&rdquo;, &ldquo;Backup&rdquo;, &ldquo;InstancesRebuilding&rdquo;, &ldquo;CustomOperation&rdquo;.
</p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.OpsRequestVolumeClaimTemplate">
OpsRequestVolumeClaimTemplate
...
<h3 id="apps.kubeblocks.io/v1alpha1.OpsResourceModifierAction">
OpsResourceModifierAction
...
<h3 id="apps.kubeblocks.io/v1alpha1.OpsService">
OpsService
...
<p>
More info: <a href="https://kubernetes.io/docs/concepts/services-networking/service/#field-spec-ports">https://kubernetes.io/docs/concepts/services-networking/service/#field-spec-ports</a>
</p>
...
<p>
Note: If the component has roles, at least one of &lsquo;roleSelector&rsquo; or &lsquo;podSelector&rsquo; must be specified.
...
<em>(Optional)</em>
<p>
Determines how the Service is exposed. Defaults to &lsquo;ClusterIP&rsquo;.
...
<p>
Note: although K8s Service type allows the &lsquo;ExternalName&rsquo; type, it is not a valid option for the expose operation.
</p>
<p>
For more info, see:
<a href="https://kubernetes.io/docs/concepts/services-networking/service/#publishing-services-service-types">https://kubernetes.io/docs/concepts/services-networking/service/#publishing-services-service-types</a>.
...
<ul>
<li>
ipFamilies=[] + ipFamilyPolicy=&ldquo;PreferDualStack&rdquo; :
...
<li>
ipFamilies=[&ldquo;IPV4&rdquo;,&ldquo;IPV6&rdquo;] + ipFamilyPolicy=&ldquo;RequiredDualStack&rdquo; :
...
<li>
ipFamilies=[&ldquo;IPV6&rdquo;,&ldquo;IPV4&rdquo;] + ipFamilyPolicy=&ldquo;RequiredDualStack&rdquo; :
The Service requires dual-stack and will only be created if the cluster supports both IPv4 and IPv6.
The primary IP family is IPV6.
</li>
<li>
ipFamilies=[&ldquo;IPV4&rdquo;] + ipFamilyPolicy=&ldquo;SingleStack&rdquo; :
The Service uses a single-stack with IPv4 only.
</li>
<li>
ipFamilies=[&ldquo;IPV6&rdquo;] + ipFamilyPolicy=&ldquo;SingleStack&rdquo; :
...
<ul>
<li>
&lsquo;SingleStack&rsquo; (default) : The Service uses a single IP family.
If no value is provided, IPFamilyPolicy defaults to SingleStack.
</li>
<li>
&lsquo;PreferDualStack&rsquo; : The Service prefers to use two IP families on dual-stack configured clusters
or a single IP family on single-stack clusters.
</li>
<li>
&lsquo;RequiredDualStack&rsquo; : The Service requires two IP families on dual-stack configured clusters.
...
<h3 id="apps.kubeblocks.io/v1alpha1.OpsType">
OpsType
(`string` alias)
</h3>
<p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.OpsVarSource">
OpsVarSource
...
Used to specify the source of the variable, which can be either &ldquo;env&rdquo; or &ldquo;envFrom&rdquo;.
</p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.OpsWorkloadAction">
OpsWorkloadAction
...
<p>
Defines the workload type of the action. Valid values include &ldquo;Job&rdquo; and &ldquo;Pod&rdquo;.
</p>
<ul>
<li>
...
<li>
&ldquo;Pod&rdquo;: Creates a Pod to execute the action.
...
<p>
Specifies the PodSpec of the &lsquo;workload&rsquo; action.
</p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.OpsWorkloadType">
OpsWorkloadType
(`string` alias)
</h3>
<p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.OverrideBy">
OverrideBy
...
<h3 id="apps.kubeblocks.io/v1alpha1.Parameter">
Parameter
...
If the parameter type is an array, the format should be &ldquo;v1,v2,v3&rdquo;.
</p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.ParameterConfig">
ParameterConfig
...
<h3 id="apps.kubeblocks.io/v1alpha1.ParameterPair">
ParameterPair
...
<h3 id="apps.kubeblocks.io/v1alpha1.ParametersSchema">
ParametersSchema
...
<h3 id="apps.kubeblocks.io/v1alpha1.PodInfoExtractor">
PodInfoExtractor
...
<h3 id="apps.kubeblocks.io/v1alpha1.PodSelectionPolicy">
PodSelectionPolicy
(`string` alias)
</h3>
<p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.PodSelector">
PodSelector
...
or &lsquo;All&rsquo; (select all pods that match the podSelector).
</p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.PointInTimeRefSpec">
PointInTimeRefSpec
...
<h3 id="apps.kubeblocks.io/v1alpha1.PreCheckResult">
PreCheckResult
...
<h3 id="apps.kubeblocks.io/v1alpha1.PreCondition">
PreCondition
...
<h3 id="apps.kubeblocks.io/v1alpha1.PreConditionExec">
PreConditionExec
...
<h3 id="apps.kubeblocks.io/v1alpha1.ProgressStatus">
ProgressStatus
(`string` alias)
</h3>
<p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.ProgressStatusDetail">
ProgressStatusDetail
...
<p>
Represents the current processing state of the object, including &ldquo;Processing&rdquo;, &ldquo;Pending&rdquo;, &ldquo;Failed&rdquo;, &ldquo;Succeed&rdquo;
</p>
...
<em>(Optional)</em>
<p>
Provides a human-readable explanation of the object&rsquo;s condition.
</p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.RebuildInstance">
RebuildInstance
...
- Logical backups (e.g., &lsquo;mysqldump&rsquo; for MySQL) are unsupported in the current version.
</p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.Reconfigure">
Reconfigure
...
<div>
<p>
Reconfigure defines the parameters for updating a Component&rsquo;s configuration.
</p>
</div>
<table>
<thead>
...
<p>
Contains a list of ConfigurationItem objects, specifying the Component&rsquo;s configuration template name,
...
<h3 id="apps.kubeblocks.io/v1alpha1.ReconfiguringStatus">
ReconfiguringStatus
...
<h3 id="apps.kubeblocks.io/v1alpha1.RefNamespaceName">
RefNamespaceName
...
<h3 id="apps.kubeblocks.io/v1alpha1.ReplicaChanger">
ReplicaChanger
...
<h3 id="apps.kubeblocks.io/v1alpha1.ResourceConstraintRule">
ResourceConstraintRule
...
<h3 id="apps.kubeblocks.io/v1alpha1.Restore">
Restore
...
<ul>
<li>
RFC3339 format, e.g. &ldquo;2023-11-25T18:52:53Z&rdquo;
</li>
<li>
A human-readable date-time format, e.g. &ldquo;Jul 25,2023 18:52:53 UTC+0800&rdquo;
</li>
</ul>
...
<p>
Specifies the policy for restoring volume claims of a Component&rsquo;s Pods.
...
`deferPostReadyUntilClusterRunning`<br/>
<em>
bool
</em>
...
<p>
If false (default), PostReady actions execute when the Component reaches the &ldquo;Running&rdquo; state.
If true, PostReady actions are delayed until the entire Cluster is &ldquo;Running,&rdquo;
ensuring the cluster&rsquo;s overall stability before proceeding.
</p>
<p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.Rule">
Rule
...
<h3 id="apps.kubeblocks.io/v1alpha1.ScaleIn">
ScaleIn
...
<h3 id="apps.kubeblocks.io/v1alpha1.ScaleOut">
ScaleOut
...
<h3 id="apps.kubeblocks.io/v1alpha1.SchedulePolicy">
SchedulePolicy
...
Refer to <a href="https://en.wikipedia.org/wiki/Cron">https://en.wikipedia.org/wiki/Cron</a> for more details.
</p>
...
<em>(Optional)</em>
<p>
If specified, the cluster&rsquo;s scheduling constraints.
</p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.ScriptFrom">
ScriptFrom
...
<h3 id="apps.kubeblocks.io/v1alpha1.ScriptSecret">
ScriptSecret
...
<h3 id="apps.kubeblocks.io/v1alpha1.ScriptSpec">
ScriptSpec
...
<p>
By default, the image &ldquo;apecloud/kubeblocks-datascript:latest&rdquo; is used.
</p>
...
<p>
By default, the script is executed on the Pod associated with the service named &ldquo;&#123;clusterName&#125;-&#123;componentName&#125;&rdquo;,
...
(<a href="https://tools.ietf.org/html/rfc1123">https://tools.ietf.org/html/rfc1123</a>) and requires `type` to be &ldquo;ExternalName&rdquo;.
</p>
...
`allocateLoadBalancerNodePorts`<br/>
<em>
bool
</em>
...
When `roleSelector` is set, it adds a label selector &ldquo;kubeblocks.io/role: &#123;roleSelector&#125;&rdquo;
...
<p>
In this example, setting `roleSelector` to &ldquo;leader&rdquo; will add a label selector
&ldquo;kubeblocks.io/role: leader&rdquo; to the `serviceSpec.selector`.
...
<p>
By default, the referenced KubeBlocks Cluster&rsquo;s `clusterDefinition.spec.connectionCredential`
...
<h3 id="apps.kubeblocks.io/v1alpha1.SpecificOpsRequest">
SpecificOpsRequest
...
Hence rebuilding instances is often also referred to as &ldquo;standby reconstruction&rdquo;.
</p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.StorageConstraint">
StorageConstraint
...
<h3 id="apps.kubeblocks.io/v1alpha1.Switchover">
Switchover
...
<li>
`clusterDefinition.componentDefs[x].switchoverSpec.withoutCandidate` must be defined when using &ldquo;*&rdquo;.
</li>
</ul>
<ol>
<li>
...
<h3 id="apps.kubeblocks.io/v1alpha1.SwitchoverShortSpec">
SwitchoverShortSpec
...
<h3 id="apps.kubeblocks.io/v1alpha1.SystemAccountShortSpec">
SystemAccountShortSpec
...
<h3 id="apps.kubeblocks.io/v1alpha1.TargetInstance">
TargetInstance
...
<h3 id="apps.kubeblocks.io/v1alpha1.TypedObjectRef">
TypedObjectRef
...
<h3 id="apps.kubeblocks.io/v1alpha1.UpdatedParameters">
UpdatedParameters
...
<h3 id="apps.kubeblocks.io/v1alpha1.Upgrade">
Upgrade
...
4. (&ldquo;&rdquo;, &ldquo;&rdquo;) - upgrade to the latest service version and component definition, the operator will ensure the compatibility between the selected versions.
</p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.UpgradeComponent">
UpgradeComponent
...
<h3 id="apps.kubeblocks.io/v1alpha1.ValueFrom">
ValueFrom
...
<ul>
<li>
&ldquo;8.0.33&rdquo;: Matches the exact version &ldquo;8.0.33&rdquo;
</li>
<li>
&ldquo;8.0&rdquo;: Matches all versions starting with &ldquo;8.0&rdquo;
</li>
<li>
&rdquo;^8.0.\d&#123;1,2&#125;$&ldquo;: Matches all versions starting with &ldquo;8.0.&rdquo; followed by one or two digits.
</li>
</ul>
...
<h3 id="apps.kubeblocks.io/v1alpha1.ValueMapping">
ValueMapping
...
<h3 id="apps.kubeblocks.io/v1alpha1.VersionsContext">
VersionsContext
...
<h3 id="apps.kubeblocks.io/v1alpha1.VerticalScaling">
VerticalScaling
...
<p>
Defines the desired compute resources of the Component&rsquo;s instances.
</p>
...
<h3 id="apps.kubeblocks.io/v1alpha1.VolumeExpansion">
VolumeExpansion
...
<li>
The modified parameters are listed in the `dynamicParameters` field.
If `dynamicParameterSelectedPolicy` is set to &ldquo;all&rdquo;, modifications to `staticParameters`
can also trigger a reload.
</li>
<li>
`reloadAction` is set.
...
`downwardAPIChangeTriggeredActions`<br/>
<em>
<a href="#apps.kubeblocks.io/v1beta1.DownwardAPIChangeTriggeredAction">
[]DownwardAPIChangeTriggeredAction
</a>
...
`batchParamsFormatterTemplate`<br/>
<em>
string
</em>
...
It&rsquo;s used when `batchReload` is &lsquo;True&rsquo; to format data passed into STDIN of the script.
