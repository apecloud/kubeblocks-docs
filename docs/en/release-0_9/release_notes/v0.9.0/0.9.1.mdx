...
Read the full release note and [upgrade to KubeBlocks v0.9.1](../../user_docs/upgrade-kubeblocks/upgrade-to-latest-version) to explore more features!
...
Refer to [Upgrade to KubeBlocks v0.9.x](../../user_docs/upgrade-kubeblocks/upgrade-to-latest-version).