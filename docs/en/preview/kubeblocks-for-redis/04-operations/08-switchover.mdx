...
After the switchover is executed, the specified instance ('example-semisync-redis-redis-0') will be promoted to the primary role, while the previously primary instance ('example-semisync-redis-redis-1') will take on the secondary role.
