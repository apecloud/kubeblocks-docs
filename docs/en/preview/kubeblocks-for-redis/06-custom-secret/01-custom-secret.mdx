...
- username: The default Redis postgres user is 'root', encoded as 'cm9vdA=='.
...
KubeBlocks automatically creates a secret containing the Redis postgres credentials. Retrieve the credentials with the following commands:
...
## Summary
In this guide, you:
- Created a Kubernetes Secret to securely store a custom Redis postgres password.
