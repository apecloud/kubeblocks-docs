...
```bash
kubectl get pods -n demo -l app.kubernetes.io/instance=es-multinode,apps.kubeblocks.io/component-name=data
```

Example Output:
```bash
NAME                  READY   STATUS    RESTARTS   AGE
es-multinode-data-0   4/4     Running   0          4m28s
es-multinode-data-1   4/4     Running   0          5m27s
es-multinode-data-2   4/4     Running   0          6m25s
es-multinode-data-3   4/4     Running   0          1m25s
```
...
```bash
NAME                  READY   STATUS    RESTARTS   AGE
es-multinode-data-0   4/4     Running   0          8m20s
es-multinode-data-1   4/4     Running   0          9m19s
es-multinode-data-2   4/4     Running   0          10m
```
