...
description: Learn how to perform vertical scaling in a RabbitMQ  Cluster managed by KubeBlocks to optimize resource utilization and improve performance.
