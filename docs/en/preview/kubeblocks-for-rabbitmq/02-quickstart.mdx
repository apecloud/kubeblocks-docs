...
description: Comprehensive guide to deploying and managing RabbitMQ ReplicaSet  Clusters with KubeBlocks, including installation, configuration, and operational best practices, an alternative to dedicated operator.
keywords: [Kubernetes Operator, RabbitMQ, KubeBlocks, Helm, Cluster Management, Quick Start]
sidebar_position: 2
...
<Tabs>
  ...
  helm search repo kubeblocks-addons/rabbitmq --versions
...
rabbitmq   4.2.1,4.1.6,4.0.9,3.13.7,3.12.14,3.11.28,3.10.25,3.9.29,3.8.34   Available   21s
```
</details>
...
spec:
  ...
  componentSpecs:
    - name: rabbitmq
      ...
      # Valid options are: [4.2.1,4.1.6,4.0.9,3.13.7,3.12.14,3.11.28,3.10.25,3.9.29,3.8.34]
...
More example manifests and setups for RabbitMQ can be found in the [official KubeBlocks Add-ons RabbitMQ examples directory](https://github.com/apecloud/kubeblocks-addons/tree/main/examples/rabbitmq).
