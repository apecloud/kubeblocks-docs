...
description: Comprehensive guide to deploying and managing Qdrant ReplicaSet  Clusters with KubeBlocks, including installation, configuration, and operational best practices, an alternative to dedicated operator.
keywords: [Kubernetes Operator, Qdrant, KubeBlocks, Helm, Cluster Management, Quick Start]
sidebar_position: 2
...
<Tabs>
  ...
  helm search repo kubeblocks-addons/qdrant --versions
...
qdrant   1.15.4,1.13.4,1.10.0,1.8.4,1.8.1,1.7.3,1.5.0   Available   79s
```
</details>
...
spec:
  ...
  componentSpecs:
    - name: qdrant
      ...
      # Valid options are: [1.15.4,1.13.4,1.10.0,1.8.4,1.8.1,1.7.3,1.5.0]
...
:::tip
> More example manifests and setups for Qdrant can be found in the [official KubeBlocks Add-ons Qdrant examples directory](https://github.com/apecloud/kubeblocks-addons/tree/main/examples/qdrant).
:::
...
<Tabs>
  ...
  ```yaml
    componentSpecs:
      - name: qdrant
        serviceVersion: 1.10.0    # Valid options: [1.15.4,1.13.4,1.10.0,1.8.4,1.8.1,1.7.3,1.5.0]
  ```
  </TabItem>
</Tabs>
...
qdrant      qdrant-1.0.2           docker.io/qdrant/qdrant:v1.10.0
