...
milvus-standalone-etcd     etcd-3-1.0.0-alpha.0              3.5.15            Running   3m5s
milvus-standalone-milvus   milvus-standalone-1.0.0-alpha.0   v2.3.2            Running   114s
milvus-standalone-minio    milvus-minio-1.0.0-alpha.0        8.0.17            Running   3m5s
```
