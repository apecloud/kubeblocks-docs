...
- username: The default MongoDB postgres user is 'root', encoded as 'cm9vdA=='.
...
KubeBlocks automatically creates a secret containing the MongoDB postgres credentials. Retrieve the credentials with the following commands:
...
## Summary
In this guide, you:
- Created a Kubernetes Secret to securely store a custom MongoDB postgres password.
