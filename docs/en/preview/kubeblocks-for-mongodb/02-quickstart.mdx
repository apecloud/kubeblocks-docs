...
keywords: [Kubernetes Operator, MongoDB, KubeBlocks, Helm, Cluster Management, QuickStart]
sidebar_position: 2
...
mongodb   8.0.8,7.0.18,6.0.21,5.0.29,4.4.29   Available   26d
```
</details>
...
mongodb     6.0.21            mongo-cluster-mongodb-0   primary     Running   zone-x   x.y.z   May 18,2025 21:16 UTC+0800
mongodb     6.0.21            mongo-cluster-mongodb-1   secondary   Running   zone-x   x.y.z   May 18,2025 21:16 UTC+0800
mongodb     6.0.21            mongo-cluster-mongodb-2   secondary   Running   zone-x   x.y.z   May 18,2025 21:17 UTC+0800
...
mongodb     mongodb-1.0.1           docker.io/apecloud/percona-server-mongodb:6.0.21
