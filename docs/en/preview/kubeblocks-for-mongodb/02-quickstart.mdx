---
title: MongoDB QuickStart Guide
...
```bash
kubectl apply -f https://github.com/apecloud/kubeblocks-addons/blob/main/examples/mongodb/cluster.yaml
```
...
mongodb     mongodb-1.0.0-alpha.0   docker.io/library/mongo:6.0.16
                                    apecloud-registry.cn-zhangjiakou.cr.aliyuncs.com/apecloud/kubeblocks-tools:1.0.0-beta.47
