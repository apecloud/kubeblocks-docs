...
2. Generate credentials.
   ...
   ![backup-and-restore-backup-repo-1](/img/docs/backup-and-restore-backup-repo-1.png)

3. Create a bucket.

   Create a bucket named `test-minio` for the test.

   ![backup-and-restore-backup-repo-2](/img/docs/backup-and-restore-backup-repo-2.png)
   ![backup-and-restore-backup-repo3](/img/docs/backup-and-restore-backup-repo-3.png)
