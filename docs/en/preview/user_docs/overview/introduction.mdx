...
![Design of KubeBlocks, a general purpose database operator](/img/docs/kubeblocks_general_purpose_arch.png)
...
![KubeBlocks Architecture](/img/docs/kubeblocks-architecture-ha.png)
