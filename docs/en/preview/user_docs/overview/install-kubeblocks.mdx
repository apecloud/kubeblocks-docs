...
- Snapshot Controller installed. Follow the steps in section [Install Snapshot Controller](#install-snapshot-controller) to install it.
...
```bash
helm -n kb-system install kubeblocks kubeblocks/kubeblocks \
--version <VERSION> \
