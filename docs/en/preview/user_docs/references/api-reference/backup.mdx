...
`persistentVolumeClaimTemplate`<br/>
<em>
string
</em>
...
`bucket`, &lsquo;region&rsquo;, &lsquo;accessKey&rsquo;, &lsquo;secretKey&rsquo;, or something else for S3 storage.
...
`requiredPolicyForAllPodSelection`<br/>
<em>
