...
* **Change Max Worker Processes**: Sets PostgreSQL max_worker_processes default to 8 [#1679](https://github.com/apecloud/kubeblocks-addons/pull/1679).
...
* **New Version Support**: Adds support for latest MongoDB versions [#1431](https://github.com/apecloud/kubeblocks-addons/pull/1431), [#1590](https://github.com/apecloud/kubeblocks-addons/pull/1590)
...
* **New Versions**: Adds support for latest RabbitMQ versions [#1596](https://github.com/apecloud/kubeblocks-addons/pull/1596)
