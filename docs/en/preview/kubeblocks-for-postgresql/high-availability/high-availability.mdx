...
1. View the initial status of the PostgreSQL cluster and pods.
   ...
   ![PostgreSQL cluster original status](/img/docs/api-ha-pg-original-status.png)
...
4. Connect to the PostgreSQL cluster to view the replication information.
   ...
   ![PostgreSQL replication info](/img/docs/api-ha-pg-replication-info.png)
...
5. View the status of the PostgreSQL cluster and pods again.
   ...
   ![PostgreSQL cluster status after HA](/img/docs/api-ha-pg-after.png)
...
1. View the initial status of the PostgreSQL cluster.
   ...
   ![PostgreSQL cluster original status](/img/docs/pgsql-ha-before.png)
...
4. Connect to the PostgreSQL cluster to view the replication information.
   ...
   ![PostgreSQL replication info](/img/docs/pgsql-ha-pg_stat_replication.png)
...
5. Describe the cluster and check the instance role.
   ...
   ![PostgreSQL cluster status after HA](/img/docs/pgsql-ha-after.png)
