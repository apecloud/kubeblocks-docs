...
- Rebuild replicas using both in-place and non-in-place methods

**What is Replica Rebuilding**

Replica rebuilding is the process of recreating a PostgreSQL replica from scratch while maintaining:
...
## Choosing Between Rebuild Methods

- When you want to maintain the same Pod name and PVC name, use In-Place Rebuild
- When you want to gain more reliability (problematic replica won't be terminated until new replica is online) , use Non-In-Place Rebuild
