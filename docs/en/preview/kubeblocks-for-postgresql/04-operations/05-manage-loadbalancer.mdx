...
External services addresses allow public internet access to the PostgreSQL service, while internal services addresses restrict access to the user’s VPC.
...
Expected Result: The 'pg-cluster-postgresql-internet' Service should have be removed.
