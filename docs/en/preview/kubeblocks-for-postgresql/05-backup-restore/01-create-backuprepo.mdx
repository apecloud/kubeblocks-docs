...
More detailed information about BackupRepo can be found in the [BackupRepo](../../user_docs/references/backuprepo) reference and more StorageProvider CRs can be found in the Github [StorageProvider](https://github.com/apecloud/kubeblocks-storage-providers) repository.
