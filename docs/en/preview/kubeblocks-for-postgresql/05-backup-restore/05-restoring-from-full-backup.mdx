...
2. **Ops API Method** - Enhanced operational control with progress monitoring

Key differences:
- Ops API provides real-time status updates
- Ops API supports additional operational controls
- Both methods ultimately perform the same restore operation
...
## Method 2: Ops API Restoration

### Step 1: Initiate Restore Operation
Create restore request via Ops API:
...
2. **Ops API** - Enhanced operational control
