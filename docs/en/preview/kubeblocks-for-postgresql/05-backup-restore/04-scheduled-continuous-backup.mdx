...
You may perform a sysbench benchmark against the cluster or you can run the python script [pg_benchmark](https://github.com/apecloud/kubeblocks-addons/blob/main/examples/postgresql/test/pg_benchmark.py) to benchmark the cluster.
