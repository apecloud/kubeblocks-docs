...
sidebar_position: 9
sidebar_label: Decommission a Pod  
---
...
kind: OpsRequest
metadata:
  name: example-mysql-cluster-decommision-ops
  namespace: demo
spec:
...
```bash
kubectl describe ops example-mysql-cluster-decommision-ops -n demo
```
Expected Output:
