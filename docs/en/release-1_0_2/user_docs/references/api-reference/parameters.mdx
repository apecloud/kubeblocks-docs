...
<h3 id="parameters.kubeblocks.io/v1alpha1.ComponentParameter">
ComponentParameter
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ParamConfigRenderer">
ParamConfigRenderer
...
<p>
Specifies the ParametersDefinition custom resource (CR) that defines the Component parameter&rsquo;s schema and behavior.
</p>
...
<h3 id="parameters.kubeblocks.io/v1alpha1.Parameter">
Parameter
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ParametersDefinition">
...
<td>
<code>ParametersDefinition</code>
</td>
...
<h3 id="parameters.kubeblocks.io/v1alpha1.AutoTrigger">
AutoTrigger
...
<h3 id="parameters.kubeblocks.io/v1alpha1.CfgFileFormat">
CfgFileFormat
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ComponentConfigDescription">
ComponentConfigDescription
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ComponentParameterSpec">
ComponentParameterSpec
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ComponentParameterStatus">
ComponentParameterStatus
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ComponentParameters">
ComponentParameters
(<code>map[string]&ast;string</code> alias)
</h3>
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ComponentParametersSpec">
ComponentParametersSpec
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ComponentReconfiguringStatus">
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ConfigTemplateExtension">
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ConfigTemplateItemDetail">
ConfigTemplateItemDetail
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ConfigTemplateItemDetailStatus">
ConfigTemplateItemDetailStatus
...
<h3 id="parameters.kubeblocks.io/v1alpha1.DownwardAPIChangeTriggeredAction">
DownwardAPIChangeTriggeredAction
...
<h3 id="parameters.kubeblocks.io/v1alpha1.DynamicParameterSelectedPolicy">
...
<h3 id="parameters.kubeblocks.io/v1alpha1.DynamicReloadType">
DynamicReloadType
(<code>string</code> alias)
</h3>
<div>
...
<h3 id="parameters.kubeblocks.io/v1alpha1.FileFormatConfig">
FileFormatConfig
...
<h3 id="parameters.kubeblocks.io/v1alpha1.FormatterAction">
FormatterAction
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ImageMapping">
ImageMapping
...
<h3 id="parameters.kubeblocks.io/v1alpha1.IniConfig">
IniConfig
...
<h3 id="parameters.kubeblocks.io/v1alpha1.MergedPolicy">
MergedPolicy
(<code>string</code> alias)
</h3>
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ParamConfigRendererSpec">
ParamConfigRendererSpec
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ParamConfigRendererStatus">
ParamConfigRendererStatus
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ParameterDeletedMethod">
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ParameterDeletedPolicy">
ParameterDeletedPolicy
...
If set to &ldquo;Reset&rdquo;, the parameter will be re-rendered through the configuration template.
</p>
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ParameterPhase">
ParameterPhase
(<code>string</code> alias)
</h3>
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ParameterSpec">
ParameterSpec
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ParameterStatus">
ParameterStatus
...
<p>
Records the status of a reconfiguring operation if <code>opsRequest.spec.type</code> equals to &ldquo;Reconfiguring&rdquo;.
</p>
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ParametersDefinitionSpec">
ParametersDefinitionSpec
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ParametersDefinitionStatus">
ParametersDefinitionStatus
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ParametersDescPhase">
ParametersDescPhase
(<code>string</code> alias)
</h3>
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ParametersInFile">
ParametersInFile
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ParametersSchema">
ParametersSchema
...
<h3 id="parameters.kubeblocks.io/v1alpha1.Payload">
Payload
(<code>map[string]encoding/json.RawMessage</code> alias)
</h3>
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ReconcileDetail">
ReconcileDetail
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ReconfiguringStatus">
ReconfiguringStatus
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ReloadAction">
ReloadAction
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ReloadPolicy">
ReloadPolicy
(<code>string</code> alias)
</h3>
<div>
...
<h3 id="parameters.kubeblocks.io/v1alpha1.RerenderResourceType">
RerenderResourceType
(<code>string</code> alias)
</h3>
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ScriptConfig">
ScriptConfig
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ShellTrigger">
ShellTrigger
...
<h3 id="parameters.kubeblocks.io/v1alpha1.SignalType">
SignalType
(<code>string</code> alias)
</h3>
...
<h3 id="parameters.kubeblocks.io/v1alpha1.TPLScriptTrigger">
TPLScriptTrigger
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ToolConfig">
ToolConfig
...
<h3 id="parameters.kubeblocks.io/v1alpha1.ToolsSetup">
ToolsSetup
...
<h3 id="parameters.kubeblocks.io/v1alpha1.UnixSignalTrigger">
UnixSignalTrigger
