...
es-multinode-data-agent     ClusterIP   10.96.107.96    <none>        8080/TCP   6m15s
es-multinode-data-http      ClusterIP   10.96.59.205    <none>        9200/TCP   6m15s
es-multinode-master-agent   ClusterIP   10.96.122.246   <none>        8080/TCP   6m15s
es-multinode-master-http    ClusterIP   10.96.219.16    <none>        9200/TCP   6m15s
```
...
```bash
NAME                           TYPE            CLUSTER-IP     EXTERNAL-IP   PORT(S)          AGE
es-multinode-master-internet   LoadBalancer    10.96.38.72    <EXTERNAL_IP> 9200:30998/TCP   19s # LoadBalancer service
```
