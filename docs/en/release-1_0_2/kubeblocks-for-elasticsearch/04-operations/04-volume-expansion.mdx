...
data                                     1 / 1                1Gi / 1Gi               data:30Gi      <STORAGE_CLASS_NAME>
```
...
data-es-multinode-data-1   Bound    pvc-uuid   30Gi       RWO            <STORAGE_CLASS_NAME>
data-es-multinode-data-2   Bound    pvc-uuid   30Gi       RWO            <STORAGE_CLASS_NAME>
```
