...
metadata:
  ...
  namespace: demo
  annotations:
    kubeblocks.io/restore-from-backup: '{"mysql":{"name":"77a788fa-example-mysql-cluster-archive-binlog","namespace":"demo","volumeRestorePolicy":"Parallel",
...
spec:
  ...
  force: false
  restore:
    backupName: 77a788fa-example-mysql-cluster-archive-binlog
