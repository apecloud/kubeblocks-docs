    ...
    - componentName: data
      scaleIn:
        onlineInstancesToOffline:
          - 'es-multinode-data-1'  # Specifies the instance names that need to be taken offline
  ```
  ...
  spec:
    componentSpecs:
      - name: data
        ...
        offlineInstances:
          - es-multinode-data-1   # <----- Specify Pod to be decommissioned
   ...
  ```
  </TabItem>
...
es-multinode-data-0   4/4     Running   0          24m
es-multinode-data-2   4/4     Running   0          2m1s
```
