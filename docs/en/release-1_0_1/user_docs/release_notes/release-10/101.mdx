---
title: v1.0.1
description: Release Notes v1.0.1
...
- Support reconfiguration on Redis cluster for client-output-buffer-limit ([#1973](https://github.com/apecloud/kubeblocks-addons/pull/1973))
