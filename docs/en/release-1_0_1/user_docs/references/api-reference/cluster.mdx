...
`persistentVolumeClaimRetentionPolicy`<br/>
<em>
...
`ClusterComponentConfigSource`<br/>
<em>
...
`ComponentAvailableExpression`<br/>
<em>
...
<p>
Represents the current status of the ShardingDefinition. Valid values include ``,`Available`, and`Unavailable<code>.
...
<p>
Represents the current status of the SidecarDefinition. Valid values include ``,`Available`, and`Unavailable<code>.
...
<p>
A list of roles defined in the system. Instanceset obtains role through pods&rsquo; role label `kubeblocks.io/role`.
</p>
