...
description: Learn how to perform vertical scaling in a MongoDB ReplicaSet Cluster managed by KubeBlocks to optimize resource utilization and improve performance.
...
1. Deploy a MongoDB ReplicaSet Cluster managed by KubeBlocks.
