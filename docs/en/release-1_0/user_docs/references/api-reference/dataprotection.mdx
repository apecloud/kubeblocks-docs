...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.ActionSet">
ActionSet
...
<ul>
<li>
<code>Full</code> for a full backup.
</li>
<li>
<code>Incremental</code> back up data that have changed since the last backup (either full or incremental).
</li>
<li>
<code>Differential</code> back up data that has changed since the last full backup.
</li>
<li>
<code>Continuous</code> back up transaction logs continuously, such as MySQL binlog, PostgreSQL WAL, etc.
</li>
<li>
<code>Selective</code> back up data more precisely, use custom parameters, such as specific databases or tables.
</li>
</ul>
...
<p>
Specifies the backup retention policy. This has a precedence over <code>backup.spec.retentionPeriod</code>.
</p>
...
<p>
Specifies the name of the <code>StorageProvider</code> used by this backup repository.
</p>
...
<p>
Stores the non-secret configuration parameters for the <code>StorageProvider</code>.
</p>
...
<p>
References to the secret that holds the credentials for the <code>StorageProvider</code>.
</p>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.BackupSchedule">
BackupSchedule
...
<p>
Specifies the backupPolicy to be applied for the <code>schedules</code>.
</p>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.Restore">
Restore
...
<li>
Differential: will be restored sequentially from the parent backup of the differential backup.
</li>
<li>
Continuous: will find the most recent full backup at this time point and the continuous backups after it to restore.
</li>
</ol>
...
<p>
Configuration for the action of &ldquo;prepareData&rdquo; phase, including the persistent volume claims
...
<p>
Configuration for the action of &ldquo;postReady&rdquo; phase.
</p>
...
<p>
The priority of merging is as follows: <code>Restore env &gt; Backup env &gt; ActionSet env</code>.
</p>
...
<p>
Specifies the required resources of restore job&rsquo;s container.
</p>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.StorageProvider">
StorageProvider
...
<p>
A Go template that used to render and generate <code>k8s.io/api/core/v1.Secret</code>
...
<p>
A Go template utilized to render and generate <code>kubernetes.storage.k8s.io.v1.StorageClass</code>
resources. The `StorageClass&rsquo; created by this template is aimed at using the CSI driver.
</p>
...
<p>
A Go template that renders and generates <code>k8s.io/api/core/v1.PersistentVolumeClaim</code>
...
<p>
A Go template used to render and generate <code>k8s.io/api/core/v1.Secret</code>.
...
and <code>kbcli</code> uses this definition for dynamic command-line parameter parsing.
</p>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.AccessMethod">
AccessMethod
...
how the <code>BackupRepo</code> can be accessed.
</p>
</div>
<table>
<thead>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.ActionErrorMode">
ActionErrorMode
(<code>string</code> alias)
</h3>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.ActionPhase">
ActionPhase
(<code>string</code> alias)
</h3>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.ActionSetParametersSchema">
ActionSetParametersSchema
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.ActionSetSpec">
ActionSetSpec
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.ActionSetStatus">
ActionSetStatus
...
<p>
Indicates the phase of the ActionSet. This can be either &lsquo;Available&rsquo; or &lsquo;Unavailable&rsquo;.
</p>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.ActionSpec">
ActionSpec
...
<p>
Specifies that the action should be executed using the pod&rsquo;s exec API within a container.
</p>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.ActionStatus">
ActionStatus
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.ActionType">
ActionType
(<code>string</code> alias)
</h3>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.BackupActionSpec">
BackupActionSpec
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.BackupDataActionSpec">
BackupDataActionSpec
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.BackupDeletionPolicy">
BackupDeletionPolicy
(<code>string</code> alias)
</h3>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.BackupMethodTPL">
BackupMethodTPL
...
If this field is not set, the selection method specified in <code>backupPolicy.target</code> is used.
</p>

<p>
This field provides a way to override the global <code>backupPolicy.target</code> setting for specific BackupMethod.
</p>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.BackupPolicyRetentionPolicy">
BackupPolicyRetentionPolicy
(<code>string</code> alias)
</h3>
...
It refers to the BackupPolicy&rsquo;s generation, which is updated on mutation by the API Server.
</p>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.BackupPolicyTemplate">
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.BackupPolicyTemplateSpec">
BackupPolicyTemplateSpec
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.BackupPolicyTemplateStatus">
BackupPolicyTemplateStatus
...
<p>
Specifies the current phase of the BackupPolicyTemplate. Valid values are <code>empty</code>, <code>Available</code>, <code>Unavailable</code>.
When <code>Available</code>, the BackupPolicyTemplate is ready and can be referenced by related objects.
</p>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.BackupRef">
BackupRef
...
<p>
BackupRepoPhase denotes different stages for the <code>BackupRepo</code>.
</p>
</div>
<table>
<thead>
...
<p>
BackupRepoSpec defines the desired state of <code>BackupRepo</code>.
</p>
</div>
<table>
<thead>
...
<p>
BackupRepoStatus defines the observed state of <code>BackupRepo</code>.
</p>
</div>
<table>
<thead>
...
<p>
Refers to the generated secret for the <code>StorageProvider</code>.
</p>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.BackupSchedulePhase">
BackupSchedulePhase
(<code>string</code> alias)
</h3>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.BackupScheduleSpec">
BackupScheduleSpec
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.BackupScheduleStatus">
BackupScheduleStatus
...
A &lsquo;null&rsquo; value implies that the backup will not be cleaned up unless manually deleted.
</p>
...
The server&rsquo;s time is used for this timestamp.
</p>
...
When converted to a string, the format is &ldquo;1h2m0.5s&rdquo;.
</p>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.BackupStatusTarget">
BackupStatusTarget
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.BackupTarget">
BackupTarget
...
<p>
Specifies a mandatory and unique identifier for each target when using the &ldquo;targets&rdquo; field.
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.BackupTimeRange">
BackupTimeRange
...
<p>
time zone, supports only zone offset, with a value range of &ldquo;-12:59 ~ +13:00&rdquo;.
</p>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.BaseJobActionSpec">
BaseJobActionSpec
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.ConnectionCredential">
ConnectionCredential
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.ContainerPort">
ContainerPort
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.DataRestorePolicy">
DataRestorePolicy
(<code>string</code> alias)
</h3>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.EncryptionConfig">
EncryptionConfig
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.EnvVar">
EnvVar
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.ExecAction">
ExecAction
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.ExecActionSpec">
ExecActionSpec
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.ExecActionTarget">
ExecActionTarget
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.IncludeResource">
IncludeResource
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.JobAction">
JobAction
...
<p>
Specifies the restore policy, which is required when the pod selection strategy for the source target is &lsquo;All&rsquo;.
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.JobActionSpec">
JobActionSpec
...
should be set to true. Otherwise, the target pod&rsquo;s volumes will be ignored.
</p>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.JobActionTarget">
JobActionTarget
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.KubeResources">
KubeResources
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.ParameterPair">
ParameterPair
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.ParametersSchema">
ParametersSchema
...
For instance, these should be stored in a <code>Secret</code> instead of a <code>ConfigMap</code>.
</p>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.Phase">
Phase
(<code>string</code> alias)
</h3>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.PodSelectionStrategy">
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.PodSelector">
PodSelector
...
This only takes effect when the <code>strategy</code> field below is set to <code>Any</code>.
</p>
...
<ul>
<li>
<code>Any</code>: select any one pod that match the labelsSelector.
</li>
<li>
<code>All</code>: select all pods that match the labelsSelector. The backup data for the current pod
...
And only takes effect when the &lsquo;strategy&rsquo; is set to &lsquo;Any&rsquo;.
</p>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.PrepareDataConfig">
PrepareDataConfig
...
<p>
Specifies the configuration when using <code>persistentVolumeClaim.spec.dataSourceRef</code> method for restoring.
...
<ul>
<li>
<code>Parallel</code>: parallel recovery of persistent volume claim.
</li>
<li>
<code>Serial</code>: restore the persistent volume claim in sequence, and wait until the previous persistent volume claim is restored before restoring a new one.
</li>
</ul>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.ReadinessProbe">
ReadinessProbe
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.ReadinessProbeExecAction">
ReadinessProbeExecAction
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.ReadyConfig">
ReadyConfig
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.RequiredPolicyForAllPodSelection">
RequiredPolicyForAllPodSelection
...
<p>
Specifies the name of the source target pod. This field is mandatory when the DataRestorePolicy is configured to &lsquo;OneToMany&rsquo;.
</p>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.RestoreActionSpec">
RestoreActionSpec
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.RestoreActionStatus">
RestoreActionStatus
(<code>string</code> alias)
</h3>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.RestoreKubeResources">
RestoreKubeResources
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.RestorePhase">
RestorePhase
(<code>string</code> alias)
</h3>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.RestoreSpec">
RestoreSpec
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.RestoreStage">
RestoreStage
(<code>string</code> alias)
</h3>
<div>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.RestoreStatus">
RestoreStatus
...
When converted to a string, the form is &ldquo;1h2m0.5s&rdquo;.
</p>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.RestoreStatusAction">
RestoreStatusAction
...
<p>
Describes which backup&rsquo;s restore action belongs to.
</p>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.RestoreStatusActions">
RestoreStatusActions
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.RestoreVolumeClaim">
RestoreVolumeClaim
...
More info: <a href="https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata">https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata</a>
</p>
Refer to the Kubernetes API documentation for the fields of the
<code>metadata</code> field.
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.RestoreVolumeClaimsTemplate">
RestoreVolumeClaimsTemplate
...
The format of the created claim name is <code>$(template-name)-$(index)</code>.
</p>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.RetentionPeriod">
RetentionPeriod
(<code>string</code> alias)
</h3>
...
<p>
RetentionPeriod represents a duration in the format &ldquo;1y2mo3w4d5h6m&rdquo;, where
y=year, mo=month, w=week, d=day, h=hour, m=minute.
</p>
</div>
<h3 id="dataprotection.kubeblocks.io/v1alpha1.RuntimeSettings">
RuntimeSettings
...
More info: <a href="https://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/">https://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/</a>
</p>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.SchedulePhase">
SchedulePhase
(<code>string</code> alias)
</h3>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.ScheduleStatus">
ScheduleStatus
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.SchedulingSpec">
SchedulingSpec
...
Refer to <a href="https://kubernetes.io/docs/concepts/configuration/assign-pod-node/">https://kubernetes.io/docs/concepts/configuration/assign-pod-node/</a>
</p>
...
Refer to <a href="https://kubernetes.io/docs/concepts/scheduling-eviction/topology-spread-constraints/">https://kubernetes.io/docs/concepts/scheduling-eviction/topology-spread-constraints/</a>
</p>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.SourceOfOneToMany">
SourceOfOneToMany
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.StorageProviderPhase">
...
<p>
StorageProviderPhase defines phases of a <code>StorageProvider</code>.
</p>
</div>
<table>
<thead>
...
<p>
StorageProviderNotReady indicates that the <code>StorageProvider</code> is not ready,
...
<p>
StorageProviderReady indicates that the <code>StorageProvider</code> is ready for use.
</p>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.StorageProviderSpec">
StorageProviderSpec
...
<p>
StorageProviderSpec defines the desired state of <code>StorageProvider</code>.
</p>
</div>
<table>
<thead>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.StorageProviderStatus">
StorageProviderStatus
...
<p>
StorageProviderStatus defines the observed state of <code>StorageProvider</code>.
</p>
</div>
<table>
<thead>
...
<p>
The phase of the <code>StorageProvider</code>. Valid phases are <code>NotReady</code> and <code>Ready</code>.
</p>
...
<p>
Describes the current state of the <code>StorageProvider</code>.
</p>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.SyncProgress">
SyncProgress
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.TargetInstance">
TargetInstance
...
<li>
If multiple replicas satisfy the specified role, the choice (<code>Any</code> or <code>All</code>) will be made according to
the <code>strategy</code> field below.
</li>
</ul>
...
<code>strategy</code> field below is set to <code>Any</code>.
</p>
...
<p>
If <code>backupPolicy.componentDefs</code> is set, this field is required to specify the system account name.
This account must match one listed in <code>componentDefinition.spec.systemAccounts[&ast;].name</code>.
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.TargetVolumeInfo">
TargetVolumeInfo
...
<p>
Specifies the mount for the volumes specified in <code>volumes</code> section.
</p>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.ValueFrom">
ValueFrom
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.VersionMapping">
VersionMapping
...
<ul>
<li>
&ldquo;8.0.33&rdquo;: Matches the exact name &ldquo;8.0.33&rdquo;
</li>
<li>
&ldquo;8.0&rdquo;: Matches all names starting with &ldquo;8.0&rdquo;
</li>
<li>
&rdquo;^8.0.\d&#123;1,2&#125;$&ldquo;: Matches all names starting with &ldquo;8.0.&rdquo; followed by one or two digits.
</li>
</ul>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.VolumeClaimRestorePolicy">
VolumeClaimRestorePolicy
(<code>string</code> alias)
</h3>
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.VolumeConfig">
VolumeConfig
...
<h3 id="dataprotection.kubeblocks.io/v1alpha1.VolumeSnapshotStatus">
VolumeSnapshotStatus
