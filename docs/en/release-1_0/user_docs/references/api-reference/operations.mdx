...
<h3 id="operations.kubeblocks.io/v1alpha1.OpsDefinition">
OpsDefinition
...
Jobs or Pods that execute the OpsActions defined in <code>actions</code>.
</p>
...
<h3 id="operations.kubeblocks.io/v1alpha1.OpsRequest">
OpsRequest
...
<p>
Note: Setting <code>cancel</code> to true is irreversible; further modifications to this field are ineffective.
</p>
...
pre-checks even if <code>force</code> is true.
</p>
...
<p>
Note: Once set, the <code>force</code> field is immutable and cannot be updated.
</p>
...
&ldquo;Expose&rdquo;, &ldquo;RebuildInstance&rdquo;, &ldquo;Custom&rdquo;.
</p>
...
(when <code>opsRequest.status.phase</code> is &ldquo;Succeed&rdquo;) before automatic deletion.
</p>
...
<h3 id="operations.kubeblocks.io/v1alpha1.ActionTask">
ActionTask
...
<h3 id="operations.kubeblocks.io/v1alpha1.ActionTaskStatus">
ActionTaskStatus
...
<h3 id="operations.kubeblocks.io/v1alpha1.Backup">
Backup
...
- <code>Delete</code> means that the backup content and its physical snapshot on backup repository are deleted.
</p>
...
<p>
If the <code>deletionPolicy</code> is set to &lsquo;Delete&rsquo;, then the associated backup data will also be deleted
...
<p>
If the specified BackupMethod is incremental, <code>parentBackupName</code> is required.
</p>
...
Parameters match the schema specified in the <code>actionset.spec.parametersSchema</code>
</p>
...
<h3 id="operations.kubeblocks.io/v1alpha1.BackupRefSpec">
BackupRefSpec
...
<h3 id="operations.kubeblocks.io/v1alpha1.CompletionProbe">
CompletionProbe
...
<h3 id="operations.kubeblocks.io/v1alpha1.ComponentInfo">
ComponentInfo
...
<code>KB_ACCOUNT_USERNAME</code> and <code>KB_ACCOUNT_PASSWORD</code>.
</p>
...
The <code>portName</code> is transformed by replacing &lsquo;-&rsquo; with &lsquo;_&rsquo; and converting to uppercase.
</p>
...
<h3 id="operations.kubeblocks.io/v1alpha1.ComponentOps">
ComponentOps
...
<h3 id="operations.kubeblocks.io/v1alpha1.CustomOps">
CustomOps
...
<h3 id="operations.kubeblocks.io/v1alpha1.CustomOpsComponent">
CustomOpsComponent
...
<p>
Specifies the parameters that match the schema specified in the <code>opsDefinition.spec.parametersSchema</code>.
</p>
...
<h3 id="operations.kubeblocks.io/v1alpha1.EnvVarRef">
EnvVarRef
...
<h3 id="operations.kubeblocks.io/v1alpha1.Expose">
Expose
...
from <code>cluster.spec.services</code>.
</p>

<p>
Note: If <code>componentName</code> is not specified, the <code>ports</code> and <code>selector</code> fields must be provided
...
<h3 id="operations.kubeblocks.io/v1alpha1.ExposeSwitch">
ExposeSwitch
(<code>string</code> alias)
</h3>
...
<h3 id="operations.kubeblocks.io/v1alpha1.FailurePolicyType">
FailurePolicyType
(<code>string</code> alias)
</h3>
...
<h3 id="operations.kubeblocks.io/v1alpha1.HorizontalScaling">
HorizontalScaling
...
<h3 id="operations.kubeblocks.io/v1alpha1.Instance">
Instance
...
<h3 id="operations.kubeblocks.io/v1alpha1.InstanceReplicasTemplate">
...
<h3 id="operations.kubeblocks.io/v1alpha1.InstanceResourceTemplate">
...
<h3 id="operations.kubeblocks.io/v1alpha1.InstanceVolumeClaimTemplate">
...
<h3 id="operations.kubeblocks.io/v1alpha1.JSONPatchOperation">
JSONPatchOperation
...
<h3 id="operations.kubeblocks.io/v1alpha1.LastComponentConfiguration">
...
<p>
Records the <code>replicas</code> of the Component prior to any changes.
</p>
...
<p>
Records the <code>shards</code> of the Component prior to any changes.
</p>
...
<h3 id="operations.kubeblocks.io/v1alpha1.LastConfiguration">
LastConfiguration
...
<h3 id="operations.kubeblocks.io/v1alpha1.MatchExpressions">
MatchExpressions
...
<h3 id="operations.kubeblocks.io/v1alpha1.OpsAction">
OpsAction
...
<code>resourceModifier.completionProbe.matchExpressions</code> and <code>resourceModifier.jsonPatches[&ast;].value</code>.
</li>
</ul>
...
<h3 id="operations.kubeblocks.io/v1alpha1.OpsDefinitionSpec">
OpsDefinitionSpec
...
<h3 id="operations.kubeblocks.io/v1alpha1.OpsDefinitionStatus">
OpsDefinitionStatus
...
<h3 id="operations.kubeblocks.io/v1alpha1.OpsEnvVar">
OpsEnvVar
...
<h3 id="operations.kubeblocks.io/v1alpha1.OpsExecAction">
OpsExecAction
...
<p>
Specifies a PodInfoExtractor defined in the <code>opsDefinition.spec.podInfoExtractors</code>.
</p>
...
This corresponds to the <code>-c &#123;containerName&#125;</code> option in <code>kubectl exec</code>.
</p>
...
<h3 id="operations.kubeblocks.io/v1alpha1.OpsPhase">
OpsPhase
(<code>string</code> alias)
</h3>
...
<h3 id="operations.kubeblocks.io/v1alpha1.OpsRecorder">
OpsRecorder
...
<h3 id="operations.kubeblocks.io/v1alpha1.OpsRequestBehaviour">
OpsRequestBehaviour
...
<h3 id="operations.kubeblocks.io/v1alpha1.OpsRequestComponentStatus">
...
<p>
Records the current phase of the Component, mirroring <code>cluster.status.components[componentName].phase</code>.
</p>
...
<p>
Records the timestamp when the Component last transitioned to a &ldquo;Failed&rdquo; phase.
</p>
...
<h3 id="operations.kubeblocks.io/v1alpha1.OpsRequestSpec">
OpsRequestSpec
...
<h3 id="operations.kubeblocks.io/v1alpha1.OpsRequestStatus">
OpsRequestStatus
...
&ldquo;VersionUpgrading&rdquo;, &ldquo;Exposing&rdquo;, &ldquo;Backup&rdquo;, &ldquo;InstancesRebuilding&rdquo;, &ldquo;CustomOperation&rdquo;.
</p>
...
<h3 id="operations.kubeblocks.io/v1alpha1.OpsRequestVolumeClaimTemplate">
OpsRequestVolumeClaimTemplate
...
in the <code>clusterComponentSpec.volumeClaimTemplates</code> field.
</p>
...
<h3 id="operations.kubeblocks.io/v1alpha1.OpsResourceModifierAction">
OpsResourceModifierAction
...
<h3 id="operations.kubeblocks.io/v1alpha1.OpsService">
OpsService
...
<p>
OpsService represents the parameters to dynamically create or remove a ClusterService in the <code>cluster.spec.services</code> array.
</p>
</div>
<table>
<thead>
...
<p>
Specifies the name of the Service. This name is used to set <code>clusterService.name</code>.
</p>
...
Valid options are <code>ClusterIP</code>, <code>NodePort</code>, and <code>LoadBalancer</code>.
</p>
<ul>
<li>
...
<p>
Usually assigned automatically based on the cluster configuration and the <code>ipFamilyPolicy</code> field.
...
<p>
Common combinations of <code>ipFamilies</code> and <code>ipFamilyPolicy</code> are:
</p>
<ul>
<li>
...
<h3 id="operations.kubeblocks.io/v1alpha1.OpsType">
OpsType
(<code>string</code> alias)
</h3>
...
<h3 id="operations.kubeblocks.io/v1alpha1.OpsVarSource">
OpsVarSource
...
<h3 id="operations.kubeblocks.io/v1alpha1.OpsWorkloadAction">
OpsWorkloadAction
...
Note: unlike Jobs, manually deleting a Pod does not affect the <code>backoffLimit</code>.
</li>
</ul>
...
<h3 id="operations.kubeblocks.io/v1alpha1.OpsWorkloadType">
OpsWorkloadType
(<code>string</code> alias)
</h3>
...
<h3 id="operations.kubeblocks.io/v1alpha1.Parameter">
Parameter
...
<p>
Source for the parameter&rsquo;s value. Cannot be used if value is not empty.
</p>
...
<h3 id="operations.kubeblocks.io/v1alpha1.ParameterPair">
ParameterPair
...
<h3 id="operations.kubeblocks.io/v1alpha1.ParameterSource">
ParameterSource
...
<h3 id="operations.kubeblocks.io/v1alpha1.ParametersSchema">
ParametersSchema
...
<h3 id="operations.kubeblocks.io/v1alpha1.Phase">
Phase
(<code>string</code> alias)
</h3>
...
<h3 id="operations.kubeblocks.io/v1alpha1.PodInfoExtractor">
PodInfoExtractor
...
<h3 id="operations.kubeblocks.io/v1alpha1.PodSelectionPolicy">
PodSelectionPolicy
(<code>string</code> alias)
</h3>
...
<h3 id="operations.kubeblocks.io/v1alpha1.PodSelector">
PodSelector
...
<h3 id="operations.kubeblocks.io/v1alpha1.PointInTimeRefSpec">
PointInTimeRefSpec
...
<h3 id="operations.kubeblocks.io/v1alpha1.PreCheckResult">
PreCheckResult
...
<h3 id="operations.kubeblocks.io/v1alpha1.PreCondition">
PreCondition
...
<h3 id="operations.kubeblocks.io/v1alpha1.ProgressStatus">
ProgressStatus
(<code>string</code> alias)
</h3>
...
<h3 id="operations.kubeblocks.io/v1alpha1.ProgressStatusDetail">
ProgressStatusDetail
...
<p>
<code>objectKey</code> uniquely identifies the object, which can be any K8s object, like a Pod, Job, Component, or PVC.
Either <code>objectKey</code> or <code>actionName</code> must be provided.
</p>
...
<p>
Indicates the name of an OpsAction, as defined in <code>opsDefinition.spec.actions[&ast;].name</code>.
Either <code>objectKey</code> or <code>actionName</code> must be provided.
</p>
...
<h3 id="operations.kubeblocks.io/v1alpha1.RebuildInstance">
RebuildInstance
...
<h3 id="operations.kubeblocks.io/v1alpha1.Reconfigure">
Reconfigure
...
<h3 id="operations.kubeblocks.io/v1alpha1.RefNamespaceName">
RefNamespaceName
...
<h3 id="operations.kubeblocks.io/v1alpha1.ReplicaChanger">
ReplicaChanger
...
<h3 id="operations.kubeblocks.io/v1alpha1.Restore">
Restore
...
<h3 id="operations.kubeblocks.io/v1alpha1.Rule">
Rule
...
<ul>
<li>
<code>params</code>: Input parameters.
</li>
<li>
<code>cluster</code>: The referenced Cluster object.
</li>
<li>
<code>component</code>: The referenced Component object.
</li>
</ul>
...
<p>
Specifies the error or status message reported if the <code>expression</code> does not evaluate to <code>true</code>.
</p>
...
<h3 id="operations.kubeblocks.io/v1alpha1.ScaleIn">
ScaleIn
...
<h3 id="operations.kubeblocks.io/v1alpha1.ScaleOut">
ScaleOut
...
<h3 id="operations.kubeblocks.io/v1alpha1.SpecificOpsRequest">
SpecificOpsRequest
...
<h3 id="operations.kubeblocks.io/v1alpha1.Switchover">
Switchover
...
Refer to ComponentDefinition&rsquo;s Swtichover lifecycle action for more details.
</p>
...
<h3 id="operations.kubeblocks.io/v1alpha1.TypedObjectRef">
TypedObjectRef
...
<h3 id="operations.kubeblocks.io/v1alpha1.UpdatedParameters">
UpdatedParameters
...
<h3 id="operations.kubeblocks.io/v1alpha1.Upgrade">
Upgrade
...
<h3 id="operations.kubeblocks.io/v1alpha1.UpgradeComponent">
UpgradeComponent
...
<h3 id="operations.kubeblocks.io/v1alpha1.VerticalScaling">
VerticalScaling
...
<h3 id="operations.kubeblocks.io/v1alpha1.VolumeExpansion">
VolumeExpansion
