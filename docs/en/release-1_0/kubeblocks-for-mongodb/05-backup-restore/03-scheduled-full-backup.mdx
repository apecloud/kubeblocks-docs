...
description: Learn how to deploy a MongoDB cluster using KubeBlocks and configure automated scheduled backups with retention in an S3 repository.
keywords: [MongoDB, Backup, KubeBlocks, Scheduled Backup, Kubernetes]
sidebar_position: 3
