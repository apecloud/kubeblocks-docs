...
description: Learn how to decommission (take offline) a specific Pod in a Milvus cluster managed by KubeBlocks.
keywords: [KubeBlocks, Milvus, Decommission Pod, Horizontal Scaling, Kubernetes]
sidebar_position: 9
sidebar_label: Decommission Milvus Replica
---
