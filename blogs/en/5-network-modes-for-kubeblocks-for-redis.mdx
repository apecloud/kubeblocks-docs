...
title: 5 Network Modes for KubeBlocks for Redis
description: This blog introduces 5 different network modes for Redis clusters managed by KubeBlocks, including Headless Service, Fixed Pod IP, HostNetwork, NodePort Service, and LoadBalancer Service.
date: 2025-07-15
authors:
  name: Wang Yelei
  url: https://github.com/wangyelei
  image_url: https://avatars.githubusercontent.com/u/29418692?v=4
tags: [KubeBlocks, Redis, networking, Kubernetes, service mesh, cluster networking]
image: /img/blogs/thumbnails/blog-redis-network-modes.png
---

# 5 Network Modes for KubeBlocks for Redis
