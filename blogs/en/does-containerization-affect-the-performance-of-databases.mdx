...
<img src='/img/blogs/Usage-of-containerized-workloads-by-category.png'  alt="Usage of containerized workloads by category<sup>[4]</sup>"  width='80%' style={{margin: "0 10%"}} />
...
<img src='/img/blogs/Comparison-of-system-architecture.png'  alt="Comparison of system architecture of various lightweight virtualization methods"  width='80%' style={{margin: "0 10%"}} />
...
<img src='/img/blogs/Architecture-of-runc.png'  alt="Architecture of  RunC"  width='80%' style={{margin: "0 10%"}} />
...
<img src='/img/blogs/Architecture-of-Kata-Containers.png'  alt="Architecture of Kata Containers"  width='80%' style={{margin: "0 10%"}} />
...
<img src='/img/blogs/Architecture-of-gVisor.png'  alt="Architecture of gVisor"  width='80%' style={{margin: "0 10%"}} />
<div style={{ display: "flex", justifyContent: "center", margin: "-6px 0 10px", fontSize: "12px" }}>
...
<img src='/img/blogs/Architecture-of-Firecracker.png'  alt="Architecture of Firecracker"  width='80%' style={{margin: "0 10%"}} />
<div style={{ display: "flex", justifyContent: "center", margin: "-6px 0 10px", fontSize: "12px" }}>
...
<img src='/img/blogs/CPU-performance-Sysbench-benchmark.png'  alt="CPU performance (Sysbench benchmark)"  width='80%' style={{margin: "0 10%"}} />
...
<img src='/img/blogs/CPU-performance-Dav1d-benchmark.png'  alt="CPU performance (Dav1d benchmark)"  width='80%' style={{margin: "0 10%"}} />
...
<img src='/img/blogs/Memory-access-performance.png'  alt="Memory access performance"  width='80%' style={{margin: "0 10%"}} />
<div style={{ display: "flex", justifyContent: "center", margin: "-6px 0 10px", fontSize: "12px" }}>
...
<img src='/img/blogs/Redis-performance-for-different-container-runtimes.png'  alt="Redis performance for different container runtimes"  width='80%' style={{margin: "0 10%"}} />
...
<img src='/img/blogs/Disk-read-and-write-performance.png'  alt="Disk read and write performance"  width='80%' style={{margin: "0 10%"}} />
...
<img src='/img/blogs/Disk-read-and-write-performance-tmpfs-overlay.png'  alt="Disk read and write performance (tmpfs overlay)"  width='80%' style={{margin: "0 10%"}} />
...
<img src='/img/blogs/Database-record-insertion-performance%20.png'  alt="Database record insertion performance"  width='80%' style={{margin: "0 10%"}} />
...
<img src='/img/blogs/TCP_STREAM-network-performance.png'  alt="TCP_STREAM network performance"  width='80%' style={{margin: "0 10%"}} />
...
<img src='/img/blogs/TCP_RR-TCP_CRR-and-UDP_RR-performance.png'  alt="TCP_RR, TCP_CRR and UDP_RR performance"  width='80%' style={{margin: "0 10%"}} />
...
<img src='/img/blogs/Comparison-of-legacy-and-eBPF-container-networking.png'  alt="Comparison of legacy and eBPF container networking"  width='80%' style={{margin: "0 10%"}} />
<div style={{ display: "flex", justifyContent: "center", margin: "-6px 0 10px", fontSize: "12px" }}>
...
<img src='/img/blogs/Redis-benchmark-under-legacy-host-routing-with-iptables.png'  alt="Redis benchmark under legacy host-routing with iptables"  width='80%' style={{margin: "0 10%"}} />
...
<img src='/img/blogs/Comparison-between-Host-network-and-Pod-network-under-legacy-host-routing.png'  alt="Comparison between Host network and Pod network under legacy host-routing"  width='80%' style={{margin: "0 10%"}} />
<div style={{ display: "flex", justifyContent: "center", margin: "-6px 0 10px", fontSize: "12px" }}>
...
<img src='/img/blogs/Redis-benchmark-under-eBPF-based-host-routing.png'  alt="Redis benchmark under eBPF-based host-routing"  width='80%' style={{margin: "0 10%"}} />
<div style={{ display: "flex", justifyContent: "center", margin: "-6px 0 10px", fontSize: "12px" }}>
Fig. 19. Redis benchmark under eBPF-based host-routing
</div>

<img src='/img/blogs/Comparison-between-Host-network-and-Pod-network-under-eBPF-based-host-routing.png'  alt="Comparison between Host network and Pod network under eBPF-based host-routing"  width='80%' style={{margin: "0 10%"}} />
<div style={{ display: "flex", justifyContent: "center", margin: "-6px 0 10px", fontSize: "12px" }}>
