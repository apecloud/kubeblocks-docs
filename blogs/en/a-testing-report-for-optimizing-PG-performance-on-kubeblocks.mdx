...
<img src='/img/blogs/k8s-1.jpeg' alt="TPS dropped to 0" width='80%' style={{margin: "0 10%"}} />
...
<img src='/img/blogs/k8s-2.jpeg' alt="Change spec" width='80%' style={{margin: "0 10%"}} />
...
<img src='/img/blogs/k8s-3.jpeg' alt="CPU busy rate" width='80%' style={{margin: "0 10%"}} />
...
<img src='/img/blogs/k8s-4.jpeg' alt="CPU busy rate" width='60%' style={{margin: "0 20%"}} />
...
<img src='/img/blogs/k8s-5.jpeg' alt="CPU busy rate" width='60%' style={{margin: "0 20%"}} />

We've taken a more aggressive approach to adjustment -- upgraded to an ESSD PL3 2TB disk with a bandwidth of 700MB.

<img src='/img/blogs/k8s-6.jpeg' alt="CPU busy rate" width='60%' style={{margin: "0 20%"}} />
...
<img src='/img/blogs/k8s-7.jpeg' alt="TPS drops and CPU fluctuations" width='80%' style={{margin: "0 10%"}} />
...
<img src='/img/blogs/k8s-8.jpeg' alt="dirty_background_ratio = 10" width='80%' style={{margin: "0 10%"}} />
...
<img src='/img/blogs/k8s-9.png' alt="CPU idle spiked to 80%" width='80%' style={{margin: "0 10%"}} />
...
<img src='/img/blogs/k8s-10.jpeg' alt="Entire process" width='80%' style={{margin: "0 10%"}} />
...
<img src='/img/blogs/k8s-11.png' alt="Disk bandwidth saturated" width='80%' style={{margin: "0 10%"}} />

The periods when the TPS dropped to 0 closely coincided with the moments when the checkpoint flushed dirty pages.

<img src='/img/blogs/k8s-12.jpeg' alt="Checkpoint flush" width='80%' style={{margin: "0 10%"}} />
...
<img src='/img/blogs/k8s-13.jpeg' alt="Number of locks" width='80%' style={{margin: "0 10%"}} />

Locks included:

<img src='/img/blogs/k8s-14.png' alt="Locks" width='80%' style={{margin: "0 10%"}} />
<img src='/img/blogs/k8s-15.png' alt="Locks" width='80%' style={{margin: "0 10%"}} />

At times, multiple processes contended for the same lock.

<img src='/img/blogs/k8s-16.png' alt="Lock contentions" width='80%' style={{margin: "0 10%"}} />
<img src='/img/blogs/k8s-17.png' alt="Lock contentions" width='80%' style={{margin: "0 10%"}} />
...
<img src='/img/blogs/k8s-18.png' alt="Lock contentions" width='80%' style={{margin: "0 10%"}} />
...
<img src='/img/blogs/k8s-19.png' alt="Disk bandwidth" width='80%' style={{margin: "0 10%"}} />
...
<img src='/img/blogs/k8s-20.jpg' alt="TPS drops mechanism" width='80%' style={{margin: "0 10%"}} />
...
<img src='/img/blogs/k8s-21.jpeg' alt="Disable wal_init_zero" width='60%' style={{margin: "0 20%"}} />
...
<img src='/img/blogs/k8s-22.jpeg' alt="CPU performance with full_page_write off" width='60%' style={{margin: "0 20%"}} />
<img src='/img/blogs/k8s-23.jpeg' alt="IO bandwidth performance with full_page_write off" width='60%' style={{margin: "0 20%"}} />
...
<img src='/img/blogs/k8s-24.jpeg' alt="KubeBlocks PG wal_segment 1GB vs 16MB" width='60%' style={{margin: "0 20%"}} />
...
<img src='/img/blogs/k8s-25.png' alt="CPU performance" width='60%' style={{margin: "0 20%"}} />
<img src='/img/blogs/k8s-26.png' alt="Disk R/W data performance" width='60%' style={{margin: "0 20%"}} />
...
<img src='/img/blogs/k8s-27.jpeg' alt="KubeBlocks PG vs ECS PG throughput" width='60%' style={{margin: "0 20%"}} />
...
<img src='/img/blogs/k8s-28.jpeg' alt="KubeBlocks PG vs ECS PG latency" width='60%' style={{margin: "0 20%"}} />
